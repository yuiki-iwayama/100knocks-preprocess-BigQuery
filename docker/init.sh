...
# すでにデータセットがあるかどうかの確認
bq show --format=prettyjson $GCP_PROJECT_ID:$GCP_DATA | read -d '' mydata
if [-z "$mydata"]; then
  ...
  /home/jovyan/work/data/customer.csv \
  ...
  /home/jovyan/work/data/category.csv \
  ...
  /home/jovyan/work/data/product.csv \
  ...
  /home/jovyan/work/data/store.csv \
  ...
  /home/jovyan/work/data/receipt.csv \
  ...
  /home/jovyan/work/data/geocode.csv \
